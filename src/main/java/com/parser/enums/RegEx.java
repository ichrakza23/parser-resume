...
public enum RegEx {
    ...
    EDUCATION("\\b(FORMATION(S?)|Formation(s?)|(E|É)ducation(s?)|(E|É)DUCATION(S?)|ACADEMIC QUALIFICATION(S?)|Diploma(s?)|DIPLOMA(S?))\\b"),
    EXPERIENCE("\\b(Project(s?)|Projet(s?)|Experience(s?)|EXPERIENCE(S?)|Work Experience|WORK EXPERIENCE|Work History|WORK HISTORY|Employment|EXPÉRIENCES P R O F E S S I O N N E L L E S)\\b"),
    ...
    DATEFROMTO("([A-Za-zÀ-ÿ,]+(\\s)*)([0-9]{4})(\\s)*(-|à|to)(\\s)*(\\b((P|p)resent|(C|c)urrent|(N|n)ow)\\b|([A-Za-zÀ-ÿ,]+(\\s)*([0-9]{0,4})))"),
    DATEFROMT1("([0-9]{2}(\\s)*[A-Za-zÀ-ÿ,]+(\\s)*)([0-9]{0,4})(\\s)*(-|à|to)(\\s)*(\\b((P|p)resent|(C|c)urrent|(N|n)ow)\\b|([0-9]{2}(\\s)*[A-Za-zÀ-ÿ,]+(\\s)*([0-9]{0,4})))"),
	...
	REDUNDANT_TEXT("\\b(\\w+\\s\\w+)\\b(.*\\b\\1\\b)+"),
